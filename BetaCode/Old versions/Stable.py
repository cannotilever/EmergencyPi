...
global tree, status, Running, tree2, status2, gameDisplay, LastStatus, LastStatus2, usepygame
...
def message_display(text):
    ...
    smallTextSurf, smallTextRect = text_objects('Press ENTER to Dismiss', smallText)
...
while True:
 ...
 #   print("Pygame Status: ", usepygame)
    ...
    if (status == ['Emergency']) or (status2 == ['Emergency']):
